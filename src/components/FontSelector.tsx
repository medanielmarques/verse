			...
			{CARD_FONTS.map((font) => {
				...
				return (
					<button
						...
						className={`cursor-pointer rounded border-2 px-3 py-2 text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#DFE104] focus:ring-offset-2 focus:ring-offset-[#09090B] ${
							isSelected
